...
public class Admin {
    private static final AdminResources adminResource = AdminResources.getSingleton();
    ...
    private static RoomType enterRoomType(final Scanner scanner) {
        try {
            return RoomType.valueOfTags(scanner.nextLine());
    ...
    private static void displayAllRooms() {
        Collection<InterfaceRoom> rooms = adminResource.getAllRooms();
