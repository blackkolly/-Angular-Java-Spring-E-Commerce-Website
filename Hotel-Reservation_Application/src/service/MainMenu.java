...
public class MainMenu {
    ...
    private static final HotelResources hotelResource = HotelResources.getSingleton();
    ...
    private static void findAndReserveRoom() {
        ...
        if (checkIn != null && checkOut != null) {
            Collection<InterfaceRoom> availableRooms = hotelResource.findARoom(checkIn, checkOut);

            if (availableRooms.isEmpty()) {
                Collection<InterfaceRoom> alternativeRooms = hotelResource.findAlternativeRooms(checkIn, checkOut);
    ...
    private static void reserveRoom(final Scanner scanner, final Date checkInDate,
                                    final Date checkOutDate, final Collection<InterfaceRoom> rooms) {
            ...
            if ("y".equals(haveAccount)) {
                ...
                if (hotelResource.getCustomer(customerEmail) == null) {
                    ...
                    if (rooms.stream().anyMatch(room -> room.getRoomNumber().equals(roomNumber))) {
                        final InterfaceRoom room = hotelResource.getRoom(roomNumber);
    ...
    private static void printRooms(final Collection<InterfaceRoom> rooms) {
        if (rooms.isEmpty()) {
            System.out.println("No rooms found.");
        } else {
